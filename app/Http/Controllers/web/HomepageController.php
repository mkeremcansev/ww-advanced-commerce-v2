...
class HomepageController extends Controller
{
    ...
    {
        $with = ['getOneProductAttributes', 'getOneProductImages', 'getAllProductReviews', 'getAllProductVariants.getAllVariantAttributes', 'getOneProductCategory'];
        ...
        Cache::remember('r_products', 60 * 60, function () use ($with) {
            return Product::with($with)->whereStatus(1)->inRandomOrder()->limit(8)->get();
        });
