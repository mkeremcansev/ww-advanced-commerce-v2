            ...
            <div class="ec-all-product-inner">
                <div class="ec-pro-image-outer">
                    <div class="ec-pro-image">
                        <a href="{{ route('web.product.show', $product->slug) }}" class="image">
                            <img class="main-image" src="{{ asset($d->getOneProductImages->image) }}" alt="{{ $product->title }}" />
                        </a>
                    </div>
                </div>
                <div class="ec-pro-content">
                    ...
                    <h6 class="ec-pro-stitle">
                        <a href="{{ route('web.product.show', $product->slug) }}">{{ $d->getOneProductCategory->title }}</a>
                    </h6>
