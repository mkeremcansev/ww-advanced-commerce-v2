                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link ec-foo-location"><span><img
                                                    src="{{ asset('web') }}/assets/images/icons/foo-location.svg"
                                        ...
                                        <li class="ec-footer-link ec-foo-call"><span><img
                                                    src="{{ asset('web') }}/assets/images/icons/foo-wp.svg" class="svg_img foo_svg"
                                                    alt="" /></span><a href="tel:+919999999999">+91 999 999 9999</a>
                                        </li>
                                        <li class="ec-footer-link ec-foo-mail"><span><img
                                                    src="{{ asset('web') }}/assets/images/icons/foo-mail.svg" class="svg_img foo_svg"
                                                    alt="" /></span><a
