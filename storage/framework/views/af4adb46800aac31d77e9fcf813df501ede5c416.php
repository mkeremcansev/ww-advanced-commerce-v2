...
<section class="inner-section profile-part">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a class="checkout-and-go-btn mt-1 mb-3 w-100 text-center" href="<?php echo e(route('web.account.order')); ?>">
                    <span class="checkout-label"><?php echo app('translator')->get('words.my_orders'); ?></span>
                </a>
            </div>
            <div class="col-lg-12">
...
<?php echo $__env->make('web.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/web/account/index.blade.php ENDPATH**/ ?>