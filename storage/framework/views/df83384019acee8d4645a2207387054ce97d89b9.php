            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ec-product-content">
                        <div class="ec-product-inner">
                            <h5 class="text-center p-5 custom-color-text"><?php echo app('translator')->get('words.campaign_not_have_product'); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('web.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/web/products/campaign/index.blade.php ENDPATH**/ ?>