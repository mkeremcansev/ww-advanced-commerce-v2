...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('words.slider_list'); ?>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title"><?php echo app('translator')->get('words.slider_list'); ?></h4>
                                </div>
                                    ...
                                    <table id="category_list_table" class="dt-responsive table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td></td>
                                                    <td><img width="100" src="<?php echo e(asset($s->image)); ?>" alt=""></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <a class="dropdown-item text-success" href="<?php echo e(route('panel.slider.edit', $s->id)); ?>"><?php echo app('translator')->get('words.edit'); ?></a>
                                                                <form action="<?php echo e(route('panel.slider.destroy', $s->id)); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/panel/slider/index.blade.php ENDPATH**/ ?>