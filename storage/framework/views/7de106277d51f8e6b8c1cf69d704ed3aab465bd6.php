...
<?php $__env->startSection('title', __('words.search')); ?>
        ...
        <div class="container">
            <?php if($products->count()): ?>
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5">
                    ...
                    <?php ($product = $p->getOneProductAttributes); ?>
                        <div class="col">
                            <div class="product-card <?php echo e(getStockControl($p->getAllProductVariants)); ?>">
            ...
            <div class="row row-cols-12 row-cols-md-12 row-cols-lg-12 row-cols-xl-12">
                <div class="product-card pb-5 pt-5 mt-5">
                        <h5 class="text-center"><?php echo app('translator')->get('words.search_result_not_found'); ?></h5>
                    </div>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('web.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/web/products/search/index.blade.php ENDPATH**/ ?>