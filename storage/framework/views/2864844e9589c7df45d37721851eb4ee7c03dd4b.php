...
<?php echo app('translator')->get('words.product_edit'); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.product.update.script.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="seo-tab" data-toggle="tab" href="#seo" aria-controls="about" role="tab" aria-selected="true">
                                                ...
                                                <?php echo app('translator')->get('words.seo'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                            ...
                                            <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" id="seo_title" value="<?php echo e($product->getOneProductAttributes->title); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="category_name"><?php echo app('translator')->get('words.price'); ?></label>
                                                            <input type="text" class="form-control" name="price" value="<?php echo e($product->getOneProductAttributes->price); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="discount" value="<?php echo e($product->getOneProductAttributes->discount); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->get('words.category'); ?></label>
                                                            <select class="select2 form-control" name="category_id">
                                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option <?php if($product->category_id == $c->id): ?> selected <?php endif; ?> value="<?php echo e($c->id); ?>"><?php echo e($c->title); ?></option>
                                                                    <?php if(count($c->getAllCategoriesCollection) > 0): ?>
                                                                        <?php echo $__env->make('panel.product.update.layouts.parents', ['getAllSubCategoriesCollection' => $c->getAllCategoriesCollection, 'parent_title' => $c->title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    <?php endif; ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="brand_id">
                                                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option <?php if($product->brand_id == $b->id): ?> selected <?php endif; ?> value="<?php echo e($b->id); ?>"><?php echo e($b->title); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="description"><?php echo app('translator')->get('words.description'); ?></label>
                                                            <textarea type="text" class="form-control" name="description" id="tiny"><?php echo e($product->getOneProductAttributes->description); ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="variation" aria-labelledby="variation-tab" role="tabpanel">
                                            <?php if($product->getAllProductVariants->count()): ?>
                                                <div class="card">
                                                    <div class="repeater">
                                                        <div class="card-body">
                                                            <div data-repeater-list="list">
                                                                <?php $__currentLoopData = $product->getAllProductVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div data-repeater-item>
                                                                    <div class="row d-flex align-items-end">
                                                                        <div class="col-md-10 col-12">
                                                                            <div class="form-group">
                                                                                <label for="name"><?php echo app('translator')->get('words.variation_name'); ?></label>
                                                                                <input type="text" name="variant" class="form-control" value="<?php echo e($variant->title); ?>"/>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="inner-repeater">
                                                                        <div data-repeater-list="attribute">
                                                                            <?php $__currentLoopData = $variant->getAllVariantAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div data-repeater-item>
                                                                                <div class="row d-flex align-items-end">
                                                                                    <div class="col-md-4 col-12">
                                                                                        <div class="form-group">
                                                                                            <label for=""><?php echo app('translator')->get('words.attribute_name'); ?></label>
                                                                                            <input type="text" class="form-control" name="attribute_title" value="<?php echo e($attribute->title); ?>"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3 col-12">
                                                                                        <div class="form-group">
                                                                                            <label for=""><?php echo app('translator')->get('words.attribute_stock'); ?></label>
                                                                                            <input type="text" class="form-control" name="attribute_stock" value="<?php echo e($attribute->stock); ?>"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3 col-12">
                                                                                        <div class="form-group">
                                                                                            <label for=""><?php echo app('translator')->get('words.attribute_price'); ?></label>
                                                                                            <input type="text" class="form-control" name="attribute_price" value="<?php echo e($attribute->price); ?>"/>
                                                                                        </div>
                                                                                    </div>
                                        ...
                                        <div class="tab-pane" id="images" aria-labelledby="images-tab" role="tabpanel">
                                            <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <?php $__currentLoopData = $product->getAllProductImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="col-md-3 col-6">
                                                                    <img width="220px" src="<?php echo e(asset($image->image)); ?>" class="img-fluid rounded mb-1"/>
                                                                        <div>
                                                                            <button href="<?php echo e(route('panel.product.image.destroy', $image->id)); ?>" class="btn btn-danger waves-effect waves-float waves-light mb-1"><?php echo app('translator')->get('words.delete'); ?></button>
                                                                        </div>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                ...
                                                <div class="repeater">
                                                    <div class="card-body">
                                                        <div data-repeater-list="informations">
                                                            <?php $__currentLoopData = $product->getAllProductInformations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $information): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div data-repeater-item>
                                                                <div class="row d-flex align-items-end">
                                                                    <div class="col-md-5 col-12">
                                                                        <div class="form-group">
                                                                            <label for="name"><?php echo app('translator')->get('words.title'); ?></label>
                                                                            <input type="text" name="information_title" class="form-control" value="<?php echo e($information->title); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-5 col-12">
                                                                        <div class="form-group">
                                                                            <label for="name"><?php echo app('translator')->get('words.description'); ?></label>
                                                                            <input type="text" name="information_description" class="form-control" value="<?php echo e($information->description); ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2 col-12">
                                                                        <div class="form-group">
                                        ...
                                        <div class="tab-pane" id="seo" aria-labelledby="seo-tab" role="tabpanel">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="name"><?php echo app('translator')->get('words.seo_description'); ?></label>
                                                        <textarea type="text" class="form-control" name="seo_description" id="seo_description"><?php echo e($product->getOneProductSeoAttributes->description); ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name"><?php echo app('translator')->get('words.keywords'); ?></label>
                                                        <textarea type="text" class="form-control" name="keywords" id="keywords"><?php echo e($product->getOneProductSeoAttributes->keywords); ?></textarea>
                                                    </div>
                                                    <div class="form-group bg-white p-5 rounded">
                                                        <label for="name" class="seo-p-color"><?php echo e(route('web.index')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/panel/product/update/index.blade.php ENDPATH**/ ?>