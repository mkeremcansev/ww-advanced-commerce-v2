<div class="container mt-3">
    <?php $__currentLoopData = Cache::get('showcases'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row mb-4">
            <?php $__currentLoopData = $s->getAllShowcaseAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-sm-<?php echo e(showcaseColonCalc($s->getAllShowcaseAttributes->count())); ?> col-md-<?php echo e(showcaseColonCalc($s->getAllShowcaseAttributes->count())); ?> col-lg-<?php echo e(showcaseColonCalc($s->getAllShowcaseAttributes->count())); ?>">
                    <div class="promo-img">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/web/homepage/layouts/showcase.blade.php ENDPATH**/ ?>