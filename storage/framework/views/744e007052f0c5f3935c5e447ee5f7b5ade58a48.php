<?php if(Cache::get('d_products')->count()): ?>
            ...
            <div class="ec-all-product-inner">
                <div class="ec-pro-image-outer">
                    <div class="ec-pro-image">
                        <a href="<?php echo e(route('web.product.show', $product->slug)); ?>" class="image">
                            <img class="main-image" src="<?php echo e(asset($d->getOneProductImages->image)); ?>" alt="<?php echo e($product->title); ?>" />
                        </a>
                    </div>
                </div>
                <div class="ec-pro-content">
                    ...
                    <h6 class="ec-pro-stitle">
                        <a href="<?php echo e(route('web.product.show', $product->slug)); ?>"><?php echo e($d->getOneProductCategory->title); ?></a>
                    </h6>
...
<?php endif; ?><?php /**PATH C:\laragon\www\eticaretiniz\resources\views/web/homepage/layouts/discount.blade.php ENDPATH**/ ?>